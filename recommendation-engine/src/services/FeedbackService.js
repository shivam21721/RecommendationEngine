    ...
    addMenuFeedback(feedback) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const feedbackData = Object.assign(Object.assign({}, feedback), { feedbackDate: dateString, sentimentScore });
                const feedbackId = yield this.feedbackRepository.addFeedback(feedbackData);
                const response = {
                    status: 'success',
